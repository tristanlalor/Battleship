...
public class CellPaneW extends CellPane
{
   ...
   public CellPaneW(CellStatus cellStatus, int row, int col, boolean userBoard)
   {
      super();
      this.row = row;
      this.col = col;
...
//       return fill;
//    }
//    public int getNuWircles()
//    {
//       return nuWircles;
//    }
//    public void setNuWircles(int n)
//    {
//        nuWircles = n;
...
//    }
   ...
   {
      Image xImage = new Image("shipW.png",83,83,false,false);
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      stackPane.getChildren().add(imageView);
...
//          stackPane.getChildren().add(t);
   ...
   public void userHit()
   {
      Image xImage = new Image("userHitW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("userSunkW.gif",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("computerNothingW.gif",83,83,false,false);
      Image xImage2 = new Image("smallW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
...
//                    "-fx-border-color: black;");
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("xW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
...
//                    "-fx-border-color: black;");
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("topW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("bottomW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("vW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("leftW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("rightW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
   ...
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("hW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
      stackPane.getChildren().add(imageView);
   ...
   public void userTopHit()
   {
      Image xImage = new Image("waterW.gif",83,83,false,false);
      Image xImage2 = new Image("topW.png",83,83,false,false);
      Image xImage3 = new Image("smallW.png",83,83,false,false);
      StackPane stackPane = new StackPane();
      ImageView imageView = new ImageView(xImage);
      ImageView imageView2 = new ImageView(xImage2);
